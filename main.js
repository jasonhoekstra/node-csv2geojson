...
new Lazy(fs.createReadStream(inFile, { encoding: 'utf-8' }))
    .lines
    .forEach(
	function(line) 
	{ 	
		...
		if (i==0) {
			...
			var foundLat = false; var foundLon = false;
			...
			//console.log(colCount + ' ' + elementArray.length);
